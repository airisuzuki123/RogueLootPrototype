...
- 巨躯炮台：通过；升级前五为 体积共鸣(128)、迟缓共鸣(120)、分裂射击(116)、穿透弹芯(110)、巨体回响(88)；商店前五为 体积共鸣(132)、分裂射击(129)、迟缓共鸣(123)、穿透弹芯(99)、巨体回响(90)；清群候选 升级 4 / 商店 4；路线覆盖 升级 4 / 商店 4；路线分数 bulk 3 / agile 0 / pierce 2 / blast 2 / chain 0 / close 1；主动标签 `large_body`, `slow_move`。
- 沉稳射手：通过；升级前五为 静立聚焦(107)、穿透弹芯(103)、锚定释放(70)、贯穿增幅(68)、强击弹体(55)；商店前五为 静立聚焦(110)、穿透弹芯(92)、锚定释放(72)、贯穿增幅(70)、巨体回响(52)；清群候选 升级 2 / 商店 2；路线覆盖 升级 5 / 商店 4；路线分数 bulk 2 / agile 0 / pierce 2 / blast 0 / chain 1 / close 0；主动标签 `stationary`。
- 贴身刃卫：通过；升级前五为 巨体回响(220)、护身锋刃(124)、破阵反应(112)、近身刀环(79)、脉冲场(79)；商店前五为 巨体回响(226)、护身锋刃(128)、破阵反应(116)、近身刀环(87)、脉冲场(87)；清群候选 升级 3 / 商店 3；路线覆盖 升级 4 / 商店 4；路线分数 bulk 1 / agile 1 / pierce 0 / blast 0 / chain 0 / close 2；主动标签 `shielded`, `close_skill`。
...
|---|---:|---|---|---|---|---|
| 体积共鸣 | 128 | blue | bulk | large_body |  | 否 |
| 迟缓共鸣 | 120 | blue | bulk | slow_move |  | 否 |
| 分裂射击 | 116 | purple | bulk, pierce |  |  | 是 |
| 穿透弹芯 | 110 | green | pierce |  |  | 是 |
| 巨体回响 | 88 | blue | bulk, close |  |  | 否 |
| 爆裂核心 | 74 | purple | bulk, blast |  |  | 是 |
...
| 技能 | 权重 | 稀有度 | 路线 | 标签命中 | 冲突命中 | 清群 |
|---|---:|---|---|---|---|---|
| 体积共鸣 | 132 | blue | bulk | large_body |  | 否 |
| 分裂射击 | 129 | purple | bulk, pierce |  |  | 是 |
| 迟缓共鸣 | 123 | blue | bulk | slow_move |  | 否 |
| 穿透弹芯 | 99 | green | pierce |  |  | 是 |
...
- 审计结果：通过，清群候选 升级 2 / 商店 2，路线覆盖 升级 5 / 商店 4
...
- 审计结果：通过，清群候选 升级 3 / 商店 3，路线覆盖 升级 4 / 商店 4
